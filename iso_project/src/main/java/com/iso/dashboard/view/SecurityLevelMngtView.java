...
import com.iso.dashboard.controller.SecurityLevelMngtController;
 ...
 * @author 
 */
public class SecurityLevelMngtView extends Panel implements View {
...
//        setSpacing(false);
        ...
        root.setCaption(BundleUtils.getStringCas("menu.selMngt"));
        root.setSizeFull();
...
//        addComponent(buildToolbar());
        new SecurityLevelMngtController(this);
    }
...
//        table.setSizeFull();
//        table.setContainerDataSource(new BeanItemContainer<>(User.class, userList));
...
//        searchForm.setCaptionAsHtml(true);
        ...
        txtUserName.setInputPrompt(BundleUtils.getString("securityLevelMngt.list.name"));
