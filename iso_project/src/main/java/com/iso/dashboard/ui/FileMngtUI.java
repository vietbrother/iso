 ...
 * @author 
 */
public class FileMngtUI extends CustomComponent {
...
////        mainLayout.setComponentAlignment(fields, Alignment.MIDDLE_CENTER);
    ...
    public Component buildFieldsInfo() {
        ...
        txtUsername.setRequired(true);
        txtUsername.setDescription(BundleUtils.getString("fileMngt.list.code"));
        txtUsername.setCaption(BundleUtils.getString("fileMngt.list.code"));
        ...
        txtEmail.setRequired(true);
        txtEmail.setDescription(BundleUtils.getString("fileMngt.list.name"));
        txtEmail.setCaption(BundleUtils.getString("fileMngt.list.name"));
        ...
        txtMobile.setRequired(true);
        txtMobile.setDescription(BundleUtils.getString("fileMngt.list.type"));
        txtMobile.setCaption(BundleUtils.getString("fileMngt.list.type"));
        ...
        txtFullname.setRequired(true);
        txtFullname.setDescription(BundleUtils.getString("fileMngt.list.security"));
        txtFullname.setCaption(BundleUtils.getString("fileMngt.list.security"));               
        ...
        txtparttime.setRequired(true);
        txtparttime.setDescription(BundleUtils.getString("fileMngt.list.parttime"));
        txtparttime.setCaption(BundleUtils.getString("fileMngt.list.parttime"));
        ...
        txtdepartmenttime.setRequired(true);
        txtdepartmenttime.setDescription(BundleUtils.getString("fileMngt.list.departmenttime"));
        txtdepartmenttime.setCaption(BundleUtils.getString("fileMngt.list.departmenttime"));
        ...
        txtRole.setRequired(true);
        txtRole.setDescription(BundleUtils.getString("fileMngt.list.status"));
        txtRole.setCaption(BundleUtils.getString("fileMngt.list.status"));
