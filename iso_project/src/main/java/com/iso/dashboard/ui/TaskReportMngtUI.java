...
//        uploadImport = new Uploader();
        ...
        txaContentCheck.setRequired(true);
        txaContentCheck.setDescription(BundleUtils.getString("task.attach.list.contentAction"));
        txaContentCheck.setCaption(BundleUtils.getString("task.attach.list.contentAction"));
        txaContentCheck.setInputPrompt(BundleUtils.getString("task.attach.list.contentAction"));
        ...
        pbTimeCheck.setCaption(BundleUtils.getString("task.attach.list.time"));
        pbTimeCheck.setInputPrompt(BundleUtils.getString("task.attach.list.time"));
